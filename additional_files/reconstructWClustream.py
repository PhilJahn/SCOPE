...
def main(args):
    ...
    f = open(
        f'run_logs_re2/{args.ds}_{args.method}_{args.offline}_{args.sumlimit}_{args.gennum}_{args.gpu}_{args.category}_{args.startindex}.txt',
        'w',
        newline='\n', buffering=100)
    offline_dicts = {}
    ...
    if args.category == "density":
        ...
        offlinemethods.append("rnndbscan")
        offlinemethods.append("mdbscan")
    elif args.category == "nkest_noscar":
