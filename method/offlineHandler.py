...
def perform_clustering(data, algorithm, args):
	if algorithm == "kmeans":
		...
		xmeans = XMeans(random_state=args["alg_seed"], allow_merging=True, check_global_score=False)
		...
		spectral = SpectralClustering(n_clusters=args["n_clusters"], random_state=args["alg_seed"], n_init=args["n_init"],
